...
Game::Game() :
	...
	m_gameLoaded(false)
{
	m_GameWindow.create(sf::VideoMode(m_Width, m_Height), "Angry Birds Clone", sf::Style::Titlebar | sf::Style::Close);
...
{
	bool m_componentLoadStatus = m_mainMenuTexture.loadFromFile("Assets/Textures/MainMenuScreen.jpg");
...
void Game::LoadGame()
{
	...
	// Create Enemy
	m_Enemy.Init(m_World, "Assets/Textures/pig.png", &m_score, &m_EnemyCount, m_Birds[0].GetVelocityPtr());
	m_Enemy.CreateEnemy(m_World, 775.0f, 450.0f);
	m_EnemyTwo.Init(m_World, "Assets/Textures/pig.png", &m_score, &m_EnemyCount, m_Birds[0].GetVelocityPtr());
	m_EnemyTwo.CreateEnemy(m_World, 1275.0f, 200.0f);
	m_EnemyThree.Init(m_World, "Assets/Textures/pig.png", &m_score, &m_EnemyCount, m_Birds[0].GetVelocityPtr());
